...
{/*we are passing song and index as props on discover page */}
const SongCard = ({song, i, isPlaying, activeSong, data}) => {
  
  const dispatch = useDispatch(); {/*Dispatch is a verb that does something to the state */}
  ...
  return(
    <div className='flex flex-col w-[250px] p-4 bg-white/5 bg-opacity-80 backdrop-blur animate-slideup rounded-lg cursor-pointer'>
      <div className='relative w-full h-56 group'>
        ...
        <img alt='song_img'  src={song.images?.coverart || logo} /> 
      </div>
